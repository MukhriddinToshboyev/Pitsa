      ...
      <ul className="sidebar-menu">
        <div onClick={handleMenuCart}>
          ...
          >
            <a
              onClick={() => setActiveSidebar("menu")}
              className={`  ${
                activeSidebar === "menu" ? "sidebar-menu__link" : ""
              }`}
              href="#icon1"
            >
        ...
        >
          <a
            onClick={() => setActiveSidebar("home")}
            className={`  ${
              activeSidebar === "home" ? "sidebar-menu__link" : ""
            }`}
            href="#icon2"
          >
            <svg
        ...
        >
          <a
            onClick={() => setActiveSidebar("discount")}
            className={`  ${
              activeSidebar === "discount" ? "sidebar-menu__link" : ""
            }`}
            href="#icon3"
          >
        ...
        >
          <a
            onClick={() => setActiveSidebar("vector")}
            className={`  ${
              activeSidebar === "vector" ? "sidebar-menu__link" : ""
            }`}
            href="#icon4"
          >
        ...
        >
          <a
            onClick={() => setActiveSidebar("message")}
            className={`  ${
              activeSidebar === "message" ? "sidebar-menu__link" : ""
            }`}
            href="#icon5"
          >
        ...
        >
          <a
            onClick={() => setActiveSidebar("account")}
            className={`  ${
              activeSidebar === "account" ? "sidebar-menu__link" : ""
            }`}
            href="#account"
          >
            <button
