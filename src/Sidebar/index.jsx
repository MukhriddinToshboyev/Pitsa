  ...
  return (
    <div className="sidebar-container">
      <ul className="sidebar-menu">
        ...
        <li className="sidebar-menu__item">
          <a href="#icon2" className="sidebar-menu__link">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <li className="sidebar-menu__item">
          <a href="#icon3" className="sidebar-menu__link">
            <img src={SidebarIcon3} alt="icon3" className="icon" />
          </a>
        </li>
        <li className="sidebar-menu__item">
          <a href="#icon4" className="sidebar-menu__link">
            <img src={SidebarIcon4} alt="icon4" className="icon" />
          </a>
        </li>
        <li className="sidebar-menu__item">
          <a href="#icon5" className="sidebar-menu__link">
            <img src={SidebarIcon5} alt="icon5" className="icon" />
          </a>
        </li>
        <li className="sidebar-menu__item">
          <a href="#icon6" className="sidebar-menu__link">
            <img src={SidebarIcon6} alt="icon6" className="icon" />
          </a>
        </li>
        <li className="sidebar-menu__item">
          <a href="#cart" className="sidebar-menu__link">
        ...
        <li className="sidebar-menu__item">
          <a href="#account" className="sidebar-menu__link">
            <button
